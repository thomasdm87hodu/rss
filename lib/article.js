...
- Every supplied post has been intentionally selected for this daily update. Use all distinct supplied posts in the article and do not filter, omit, or rank them by country, person, or keyword.
...
- Cover every supplied post with a distinct bullet or a clearly combined bullet when two posts describe the same development. Do not add posts from outside the supplied set.
